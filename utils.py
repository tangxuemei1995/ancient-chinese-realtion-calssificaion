...
#         exit()
        if use_entity_indicator:
            ...
            l = len(tokens_a)
            # print(tokens_a)
            e11_p = tokens_a.index("b")+1   # the start position of entity1
            e12_p = l-tokens_a[::-1].index("e")-1  # the end position ofentity1
            if 'm' not in tokens_a:
                print(example.text_a)
            e21_p = tokens_a.index("m")+1   # the start position ofentity2
            # the end position of entity2
            e22_p = l-tokens_a[::-1].index("n")-1
            # print(tokens_a[e11_p:e12_p])
#             print(tokens_a[e21_p:e22_p])
            # exit()
        e1 = ''.join(tokens_a[e11_p:e12_p])
        e2 = ''.join(tokens_a[e21_p:e22_p])
        tokens_b = None
        if example.text_b:
